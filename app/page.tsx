        ...
        <div className="container mx-auto px-4">
          <div className="flex h-20 items-center justify-between">
            <Link href="/" className="flex items-center space-x-2 scroll-animate [--animation-delay:100ms] fade-in-left">
              ...
              <span className="font-semibold text-lg tracking-wider">Cresta AI</span>
            </Link>
        ...
        <section className="relative py-24 md:py-32 lg:py-40 aurora-background">
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter mb-6 scroll-animate fade-in-up [--animation-delay:200ms]">
              Learn Smarter, Not Harder with <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-teal-500">Cresta AI</span>
            </h1>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4">
              ...
              {[
                ...
                { step: "02", title: "Generate Path", description: "Cresta analyzes the content and generates a personalized, structured learning pathway." },
        ...
        <section className="py-20 md:py-28" ref={testimonialsRef}>
            <div className="container mx-auto px-4">
                <div className="max-w-3xl mx-auto text-center mb-16 scroll-animate fade-in-up">
                    ...
                    <p className="mt-4 text-lg text-muted-foreground">See how Cresta AI is leveling up learning for students worldwide.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        { quote: "The way Cresta broke down my complex engineering syllabus into a manageable plan was a lifesaver. The AI-generated notes are incredibly accurate.", author: "Alex Johnson", role: "Engineering Student" },
                        ...
                        { quote: "As a law student, I'm drowning in reading. Cresta's summarization feature is pure gold. It saves me hours while ensuring I grasp the core concepts.", author: "David Chen", role: "Law Student" },
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <Accordion type="single" collapsible className="w-full space-y-4 scroll-animate fade-in-up [--animation-delay:200ms]">
                {[
                  ...
                  { q: "What subjects is Cresta AI suitable for?", a: "Cresta AI is designed to be domain-agnostic. It excels in text-heavy subjects like law, humanities, and social sciences, as well as structured fields like computer science, medicine, and engineering. If you have a syllabus, Cresta can analyze it." },
                  { q: "Is there a free trial?", a: "We offer a comprehensive free tier that allows you to experience the core features of Cresta AI. You can analyze a syllabus, generate initial materials, and see the power of our platform firsthand before committing." },
                ].map((item, index) => (
      ...
      <footer className="border-t border-foreground/10">
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="mt-12 pt-8 border-t border-foreground/10 text-center text-sm text-muted-foreground">
                <p>&copy; {new Date().getFullYear()} Cresta AI. All Rights Reserved.</p>
            </div>
        </div>
      </footer>
    </div>
